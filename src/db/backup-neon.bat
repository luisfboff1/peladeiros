...
echo ========================================
echo 🔄 BACKUP DO PELADEIROS APP (Neon PostgreSQL)
echo ========================================
...
echo    - peladeiros_full_%TIMESTAMP%.sql (completo)
echo    - peladeiros_structure_%TIMESTAMP%.sql (estrutura)
echo    - peladeiros_data_%TIMESTAMP%.sql (dados)
echo ========================================
echo.
